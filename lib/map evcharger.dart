...
class MapEVCharger extends StatefulWidget {
  const MapEVCharger({Key? key}) : super(key: key);

  @override
  State<MapEVCharger> createState() => _MapEVChargerState();
}

class _MapEVChargerState extends State<MapEVCharger> {
  var lati;
  var long;
                ...
                onPressed: () {
                  if (lati == null || long == null) {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => EVCharger(lati, long)));
                  }
                },
                child: Text('Next')),
          )
