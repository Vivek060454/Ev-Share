...
import 'EvShowroom.dart';

class MapEVShowroom extends StatefulWidget {
  const MapEVShowroom({Key? key}) : super(key: key);

  @override
  State<MapEVShowroom> createState() => _MapEVShowroomState();
}

class _MapEVShowroomState extends State<MapEVShowroom> {
  var lati;
  var long;
                ...
                onPressed: () {
                  if (lati == null || long == null) {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => EVShowroom(lati, long)));
                  }
                },
                child: Text('Next')),
          ),
