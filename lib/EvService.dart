...
class EVService extends StatefulWidget {
  final lati;
  final long;

  const EVService(this.lati, this.long, {Key? key}) : super(key: key);

  @override
  EVServiceState createState() {
    return EVServiceState();
  }
}

class EVServiceState extends State<EVService> {
