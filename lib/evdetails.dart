...
class Evdetails extends StatefulWidget {
  ...
  const Evdetails(this.product, this.lati, this.long, {Key? key})
      : super(key: key);
...
//         'UserName':FieldValue.arrayUnion(['afgs']),
...
// }
  ...
  void initState() {
    addCustomIcon();
    initBannerAd();
    // valuee =  bookmark.getItem('bookmark').toString() ;
    //print('wqlhcdqowh'+valuee);
    //bo();
    super.initState();
    _refreshJournals1();
    _refreshJournals();
  ...
  void _showForm(int? id) async {
    if (id != null) {
      ...
      widget.product['Specification'] = existingJournal['Specification'];
  ...
  late var ser = widget.product['id'];
  final LocalStorage bookmark = new LocalStorage('localstorage_app');
  bool outline = false;
...
//     if( valuee=="null"){
//       outline=false;
//       print('zsfgsdh'+valuee);
//     }
//     if( valuee!='null'){
//       outline=true;
//       print('zsfgWFEWFsdh'+valuee);
//     }
//   }
  dataa() async {
    if (outline == false) {
  ...
  Widget build(BuildContext context) {
    if (widget.product['Connector'] == 'Wall') {
      s = 'assets/wall.png';
    }
    ;
    if (widget.product['Connector'] == 'Wall(BS1363)') {
      s = 'assets/wall-bs1363.png';
    }
    ;
    if (widget.product['Connector'] == 'CCS/SAE') {
      s = 'assets/ccs-type2 (1).png';
    }
    ;
    if (widget.product['Connector'] == 'CHAdeMO') {
      s = 'assets/chademo.png';
    }
    ;
    if (widget.product['Connector'] == 'J-1772') {
      s = 'assets/j1772.png';
    }
    ;
    if (widget.product['Connector'] == 'Type 2') {
      s = 'assets/type2.png';
    }
    ;
    if (widget.product['Connector'] == 'Type 3') {
      s = 'assets/type3.png';
    }
    ;
    if (widget.product['Connector'] == 'Three Phase') {
      s = 'assets/three-phase.png';
    }
    ;
    if (widget.product['Connector'] == 'Caravan Mains Sacket') {
      s = 'assets/caravan-mains.png';
    }
    ;
    if (widget.product['Connector'] == 'GB/T 2') {
      s = 'assets/gbt2.png';
    }
    ;
    if (widget.product['Connector'] == null) {
      s = 'assets/gbt2.png';
    }
    ;
    List<Marker> _marker = [
                ...
                child: Table(
                  ...
                  children: [
                    TableRow(children: [
                      InkWell(
                        onTap: () async {
                          if (widget.product['Play'].toString() != '') {
                            final mapDir = widget.product['Play'].toString();
                            if (await canLaunch(mapDir)) {
                              launch(mapDir);
                            }
                          } else {
                      ...
                      InkWell(
                        onTap: () async {
                          if (widget.product['App'].toString() != '') {
                            final mapDir = widget.product['App'].toString();
                            if (await canLaunch(mapDir)) {
                              launch(mapDir);
                            }
                          } else {
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Align(
                      alignment: Alignment.topLeft,
                      child: Text(widget.product['Payment'],
                          style: GoogleFonts.robotoSlab(
                            textStyle: TextStyle(
                              fontSize: 14,
                            ),
            ...
            Padding(
              ...
              child: Column(
                children: [
                          ...
                          Padding(
                            ...
                            child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child:
                                      Text(widget.product['Amni'][i].toString(),
                                          style: GoogleFonts.robotoSlab(
                                            textStyle: TextStyle(
                                              fontSize: 14,
                                            ),
                  ...
                  //                 Align(
                  //                     alignment: Alignment.topLeft,
                  //                     child: Text(widget.product['Amni'].toString(),style: GoogleFonts.robotoSlab(textStyle: TextStyle(
                  // fontSize: 14,),
                  // ),)),
                ],
              ),
...
//                 Padding(
//                   padding: const EdgeInsets.all(8.0),
//                   child:widget.product['dataa'].length==null?Container(): Container(
//                     // decoration: BoxDecoration(
//                     //   borderRadius: BorderRadius.circular(0),
//                     //   color: Colors.white,
//                     //   boxShadow: [
...
//                                   CircleAvatar(
//                                     radius: 15,
// child: Text((widget.product['dataa'][i]['UserName']).toString().substring(0,1),),
//                                   ),
//                                   SizedBox(
//                                     width: 10,
//                                   ),
//                                   Text((widget.product['dataa'][i]['UserName']).toString(), style: GoogleFonts.signika(textStyle: TextStyle(
...
//                             children: [
//                               RatingBar.builder(
//                                 initialRating: double.parse(widget.product['dataa'][i]['Rating']),
//                                 itemPadding : EdgeInsets.all(0),
//                                 itemSize:15,
//     ignoreGestures:false,
...
//                                 width: 50,
//                               ),
//                               Text((widget.product['dataa'][i]['datee']).toString(),style: GoogleFonts.robotoSlab(textStyle: TextStyle(
//                                 fontSize: 13,color: Colors.grey),
//                               )),
//                             ],
//                           ),
//                           Align(
//                               alignment: Alignment.topLeft,
//                               child: Text((widget.product['dataa'][i]['Comment']).toString(),style: GoogleFonts.robotoSlab(textStyle: TextStyle(
//                                 fontSize: 14,),
//                               ))),
// SizedBox(
//   height: 5,
