...
class EvShowroomdetails extends StatefulWidget {
  final product;
  final lati;
  final long;

  const EvShowroomdetails(this.product, this.lati, this.long, {Key? key})
      : super(key: key);

  @override
  State<EvShowroomdetails> createState() => _EvShowroomdetailsState();
}

class _EvShowroomdetailsState extends State<EvShowroomdetails> {
      ...
      child: Container(
        child: Column(
          children: [
                ...
                : Stack(children: [
                    ...
                    widget.product['dataa'] == null
                        ...
                        : Positioned(
                            bottom: 10,
                            left: 10,
                            child: widget.product['dataa'] == null
                                ? Container()
                                : RatingBar.builder(
                                    initialRating: double.parse(
                                        su.toString().substring(0, 1)),
            ...
            //       Align(
            //         alignment: Alignment.topLeft,
            //         child: Text( 'Cost',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),),
            //       Align(
            //           alignment: Alignment.topLeft,
            //           child: Text( widget.product['Payment'],style: GoogleFonts.robotoSlab(textStyle: TextStyle(
            //             fontSize: 14,),
            //           ))),
            //     ],
            //   ),
            ...
            //       Align(
            //         alignment: Alignment.topLeft,
            //         child: Text( 'Aminities',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),),
            //       Align(
            //           alignment: Alignment.topLeft,
